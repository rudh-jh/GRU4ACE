...
SAVE_DIR = BASE_DIR / "baseline" / "BPF_FEGS_EN_LR"
...
def main():
    ...
    y_train_score = clf.predict_proba(X_train_std)[:, 1]

    y_test_pred = clf.predict(X_test_std)
    y_test_score = clf.predict_proba(X_test_std)[:, 1]
    ...
    joblib.dump(clf, SAVE_DIR / "logistic_regression.joblib")
